...
function FleetManagement() {
  ...
  const [tailNo, setTailNo] = useState("N982WC");

  const openPanel = (tail) => {
    setTailNo(tail);
    setShowPanel(true);
  };
      ...
      <main className="main-content">
        ...
        <div className="content-wrapper">
          ...
          <div className="overview-header">
            ...
            <div>
              <p className="small-title">STRATEGIC READINESS</p>
        ...
        <div className="panel-content">
          ...
          <div className="maintenance-log">
            ...
            <div className="log-card">
              ...
              <h4>Engine #2 Vibration Anomaly</h4>

              <p>
                Abnormal thermal reading detected.
